      ...
      <main className="max-w-lg mx-auto p-4 space-y-6">
        ...
        <div className="space-y-4">
          {!isStarted ? (
            <button
              onClick={handleStart}
              className="w-full h-20 bg-blue-600 hover:bg-blue-700 text-white rounded-3xl font-bold text-xl shadow-lg shadow-blue-200 transition-all active:scale-[0.98] flex items-center justify-center gap-3"
            >
            ...
            <button
              ...
              className="w-full h-20 bg-emerald-600 hover:bg-emerald-700 text-white rounded-3xl font-bold text-xl shadow-lg shadow-emerald-200 transition-all active:scale-[0.98] flex items-center justify-center gap-3"
            >
            ...
            <button
              disabled
              className="w-full h-20 bg-slate-200 text-slate-500 rounded-3xl font-bold text-xl flex items-center justify-center gap-3"
            >
              <CheckCircle2 className="w-6 h-6" />
              Сборка завершена
            </button>
